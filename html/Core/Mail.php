...
try {
    ...
    $mail->addAddress($_SESSION['SESSINFO']['User_Email']);     // Add a recipient

    //Content
    $mail->isHTML(true);                                  // Set email format to HTML
    $mail->Subject = 'Solicitud No. '.$_SESSION['LastTicket'];
    $mail->Body    = '<html>
    <head>
        <style>
        table {
      ...
      <table width="750px">
        ...
        <tr class="DarkGray Text" style="height:400px">
            <td style="padding: 20px 0px">
              <h1>Se ha recibido tu Solicitud, sera atendida a la mayor brevedad posible</h1>
              <h3>Folio:</h3>
              <h4>'.$_SESSION['LastTicket'].'</h4>
              <br/>
              <h4>Para ver el detalle de su peticion inicie sesion o abra el sig enlace.</h4>
              <a href="http://helpit.mht-jcv.com/html/empleado/Detalle_Ticket/index.html?Ticket='.$_SESSION['LastTicket'].'">http://helpit.mht-jcv.com/html/empleado/Detalle_Ticket/index.html?Ticket='.$_SESSION['LastTicket'].'</a>
            </td>
        </tr>
        <tr>
